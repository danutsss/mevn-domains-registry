    ...
    <div class="container flex flex-col md:flex-row items-center">
      ...
      >
        <div class="flex items-center justify-center md:justify-start gap-12">
          ...
          <span class="text-white" style="margin-left: -40px"
      ...
      <div class="flex gap-10 mt-12 md:mt-0">
        <ul class="flex gap-12 text-xs">
          <li class="cursor-pointer">
            <a href="https://github.com/matei1337" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/nicolae-daniel-matei-241888221/"
              target="_blank"
            >
              <li class="cursor-pointer">
                <svg
